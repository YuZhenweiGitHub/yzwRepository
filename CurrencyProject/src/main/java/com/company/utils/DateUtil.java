...
public class DateUtil {
     ...
     * @return
     */
    public static String getDay(Object datetimes) {
        return sdfDay.format(datetimes);
    }
     ...
     * @author fh
     */
    public static boolean compareDateNoEqual(String s, String e) {
        if (fomatDate(s) == null || fomatDate(e) == null) {
            return false;
        }
        return fomatDate(s).getTime() > fomatDate(e).getTime();
     ...
     * @return
     */
    public static Date getTimeFromStr(String date) {
     ...
     * @return
     */
    public static String fomatDateToStr(Date date, DateFormat fmt) {
        try {
