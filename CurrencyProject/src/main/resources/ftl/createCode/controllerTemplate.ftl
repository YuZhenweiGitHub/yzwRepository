package com.company.controller.${packageName}.${objectNameLower};
...
import com.company.service.${packageName}.${objectNameLower}.${objectName}Manager;
...
public class ${objectName}Controller extends BaseController {
	...
	public ModelAndView save() throws Exception{
		...
		pd = this.getPageData();
		pd.put("${priStr}", this.get32UUID());	//主键
<#list fieldList as var>
		if(null != pd.get("${var[0]}")){
			pd.put("${var[0]}", pd.get("${var[0]}"));
		}
</#list>
